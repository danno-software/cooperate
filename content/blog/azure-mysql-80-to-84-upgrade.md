...
- [RDS スナップショットリストア後の pg_prewarm を gp3 vs io2 で比較したら25倍速かった話](/blog/rds-pg-prewarm-storage-comparison)

同じく移行・アップグレード時の事前検証に関する記事として、RDS スナップショットリストア後のウォームアップ時間を検証した内容も公開しています。
